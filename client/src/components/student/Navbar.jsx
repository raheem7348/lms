...
//       const {data} = await axios.get(backendUrl +  '/api/educator/update-role', {headers: `Bearer ${token}`})
//      if (data.success) {
//       setIsEducator(true)
//      }else{
...
//       <img onClick={()=>navigate('/')} src={assets.logo} alt="logo" className="w-28 lg:w-32 cursor-po" />
