    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm ">
            Course by{" "}
            <span className="text-blue-600 underline">Abdur Raheem</span>
          </p>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index)=>(
                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                  <div className="flex items-center justify-between px-4 py-3 cursor cursor-pointer select-none " onClick={()=>toggleSection(index)}>
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openSection[index] ? 'max-h-96' : 'max-h-0'}`}>
                  ...
                  pr-4 py-2 text-gray-600 border-t border-gray-300">
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
        {
          ...
          <div className="p-5">
            ...
            <button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600">{isAlreadyEnrolled ? 'Already enrolled' : 'Enroll Now'}</button>
